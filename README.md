...
```bash
https://cdn.jsdelivr.net/gh/BeviProjects/BeviCSS@v1.0.7/dist/compressed/bevi.css
```
...
<link
	rel="stylesheet"
	href="https://cdn.jsdelivr.net/gh/BeviProjects/BeviCSS@v1.0.7/dist/compressed/bevi.css"
/>
```
...
```css
@import url('https://cdn.jsdelivr.net/gh/BeviProjects/BeviCSS@v1.0.7/dist/compressed/bevi.css');
```
